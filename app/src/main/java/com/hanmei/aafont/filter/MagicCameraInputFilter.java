...
public class MagicCameraInputFilter extends GPUImageFilter{
    ...
    public MagicCameraInputFilter(){
        super(OpenGlUtils.readShaderFromRawResource(FilterSDK.sContext, R.raw.default_vertex) ,
                OpenGlUtils.readShaderFromRawResource(FilterSDK.sContext, R.raw.default_fragment));
    }
