...
public class SearchShopActivity extends BaseActivity {
    ...
    private RecordShop mRecordShop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecordShop = new RecordShop(this , username);
        ...
        mRecordAdapter = new TagAdapter<String>(recordList) {
            ...
            public View getView(FlowLayout parent, int position, String str) {
                AppCompatTextView tv = (AppCompatTextView) LayoutInflater.from(SearchShopActivity.this).inflate(R.layout.item_search_history_tv , mSearchLayout,false);
                tv.setText(str);
                return tv;
            }
        };
            ...
            public void onLongClick(View view, final int position) {
                showDialog("确定要删除该条历史记录？" , new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        mRecordShop.deleteRecord(recordList.get(position));
                    }
                });
            }
        });
            ...
            public void onClick(View view) {
                showDialog("确定要删除全部历史记录？", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        mRecordShop.deleteUsernameAllRecords();
                    }
                });
            }
        });
        ...
        mRecordShop.setNotifyDataChanged(new RecordShop.NotifyDataChanged() {
            @Override
    ...
    private void initData() {
        Observable.create(new ObservableOnSubscribe<List<String>>() {
            ...
            public void subscribe(ObservableEmitter<List<String>> emitter) throws Exception {
                emitter.onNext(mRecordShop.getRecordsByNumber(DEFAULT_RECORD_NUMBER));
            }
    ...
    protected void setMyContentView() {
        setContentView(R.layout.item_search_shop);
    }

    private void showDialog(String dialogTitle , DialogInterface.OnClickListener onClickListener){
        AlertDialog.Builder builder = new AlertDialog.Builder(SearchShopActivity.this);
