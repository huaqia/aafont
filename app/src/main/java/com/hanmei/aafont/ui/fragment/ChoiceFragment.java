...
public class ChoiceFragment extends BaseFragment {
    ...
    private void fetchData(final int type) {
        ...
        query.include("user");
        query.addWhereEqualTo("choice", true);
    ...
    class ChoiceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new ChoiceViewHolder(inflater.inflate(R.layout.item_follow, parent, false));
        }

        @Override
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            if (holder instanceof ChoiceViewHolder) {
                ChoiceViewHolder followViewHolder = (ChoiceViewHolder)holder;
