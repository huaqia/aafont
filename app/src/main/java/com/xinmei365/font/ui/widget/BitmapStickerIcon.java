...
public class BitmapStickerIcon extends DrawableResourceSticker implements StickerIconEvent {
    ...
    @IntDef({ LEFT_TOP, RIGHT_TOP, LEFT_BOTTOM, RIGHT_BOTOM ,RIGHT_MIDDLE}) @Retention(RetentionPolicy.SOURCE)
