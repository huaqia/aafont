...
public class LikeFavoriteAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context mContext;
    private ArrayList<HashMap<String, String>> mMsgs;

    public LikeFavoriteAdapter(Context context) {
        mContext = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new LikeFavoriteViewHolder(inflater.inflate(R.layout.item_like_favorite, parent, false));
    }

    @Override
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof LikeFavoriteViewHolder) {
            final LikeFavoriteViewHolder viewHolder = (LikeFavoriteViewHolder)holder;
            ...
            if (time != -1) {
                ...
                if (type != null) {
                    if (type.equals("LIKE")) {
                        viewHolder.mNotice.setText("赞了你的笔记 " + TimeUtils.getTime(time));
                    } else {
                        viewHolder.mNotice.setText("收藏了你的笔记 " + TimeUtils.getTime(time));
                    }
                }
            }
    ...
    static class LikeFavoriteViewHolder extends RecyclerView.ViewHolder {
        ...
        public LikeFavoriteViewHolder(View itemView) {
            super(itemView);
