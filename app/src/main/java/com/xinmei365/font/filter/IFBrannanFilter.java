...
public class IFBrannanFilter extends IFImageFilter {
    ...
    public IFBrannanFilter(Context paramContext) {
        super(paramContext, SHADER);
        this.addInputTexture(R.drawable.brannan_process);
        this.addInputTexture(R.drawable.brannan_blowout);
        this.addInputTexture(R.drawable.brannan_contrast);
        this.addInputTexture(R.drawable.brannan_luma);
        this.addInputTexture(R.drawable.brannan_screen);
    }
}