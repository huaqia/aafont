...
public class IFHefeFilter extends IFImageFilter {
    ...
    public IFHefeFilter(Context paramContext) {
        ...
        this.addInputTexture(R.drawable.edge_burn);
        this.addInputTexture(R.drawable.hefe_map);
        this.addInputTexture(R.drawable.hefe_gradient_map);
        this.addInputTexture(R.drawable.hefe_soft_light);
        this.addInputTexture(R.drawable.hefe_metal);
    }
}