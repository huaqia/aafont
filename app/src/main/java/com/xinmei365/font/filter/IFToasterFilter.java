...
public class IFToasterFilter extends IFImageFilter {
    ...
    public IFToasterFilter(Context paramContext) {
        ...
        this.addInputTexture(R.drawable.toaster_metal);
        this.addInputTexture(R.drawable.toaster_soft_light);
        this.addInputTexture(R.drawable.toaster_curves);
        this.addInputTexture(R.drawable.toaster_overlay_map_warm);
        this.addInputTexture(R.drawable.toaster_color_shift);
    }
}
