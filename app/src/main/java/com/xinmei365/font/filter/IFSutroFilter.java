...
public class IFSutroFilter extends IFImageFilter {
    ...
    public IFSutroFilter(Context paramContext) {
        ...
        this.addInputTexture(R.drawable.vignette_map);
        this.addInputTexture(R.drawable.sutro_metal);
        this.addInputTexture(R.drawable.soft_light);
        this.addInputTexture(R.drawable.sutro_edge_burn);
        this.addInputTexture(R.drawable.sutro_curves);
    }
}
