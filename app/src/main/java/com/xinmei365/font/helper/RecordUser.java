...
public class RecordUser {
    private final String TABLE_NAME = "recordUsers";
    private SQLiteDatabase mRecordsDb;
    private RecordSQLiteOpenHelper mRecordHelper;
    private String mUsername;
    private RecordShop.NotifyDataChanged mNotifyDataChanged;

    public RecordUser(Context context , String mUsername){
    ...
    public void setNotifyDataChanged(RecordShop.NotifyDataChanged notifyDataChanged){
